...
Generator.files = {
	...
	-- static files directory,e.g. js/css/img
	['app/static/README.md'] = static_tpl,
	-- nginx config directory
	['conf/README.md'] = ngx_conf_directory,
	-- nginx config file
	['conf/nginx-dev.conf'] = ngx_conf_tpl,
	-- nginx mime
	['conf/mime.types'] = mime_types,
	['start.sh'] = start_sh,
	['stop.sh'] = stop_sh,
	['reload.sh'] = reload_sh
}
